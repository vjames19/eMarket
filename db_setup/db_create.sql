...
-- -----------------------------------------------------
-- Table `emarket`.`payment_history`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `emarket`.`payment_history` (
...
-- -----------------------------------------------------
-- Placeholder table for view `emarket`.`active_users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `emarket`.`active_users` (`user_id` INT, `user_first_name` INT, `user_middle_name` INT, `user_last_name` INT, `user_telephone` INT, `user_creation_date` INT, `user_login_user_name` INT, `user_login_email` INT);

-- -----------------------------------------------------
-- Placeholder table for view `emarket`.`products`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `emarket`.`products` (`product_id` INT, `product_seller_id` INT, `product_info_spec_id` INT, `product_creation_date` INT, `product_depletion_date` INT, `product_spec_id` INT, `product_spec_category_id` INT, `product_spec_name` INT, `product_spec_nonbid_price` INT, `product_spec_starting_bid_price` INT, `product_spec_bid_end_date` INT, `product_spec_shipping_price` INT, `product_spec_quantity` INT, `product_spec_description` INT, `product_spec_condition` INT, `product_spec_picture` INT, `product_spec_brand` INT, `product_spec_model` INT, `product_spec_dimensions` INT, `product_spec_is_draft` INT, `product_quantity_remaining` INT, `seller_name` INT, `category_id` INT, `category_name` INT, `current_bid` INT);

-- -----------------------------------------------------
-- Placeholder table for view `emarket`.`report_params`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `emarket`.`report_params` (`operation_cost` INT, `sales_fee_percent` INT);

-- -----------------------------------------------------
-- Placeholder table for view `emarket`.`report_items`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `emarket`.`report_items` (`category_id` INT, `category_name` INT, `invoice_creation_date` INT, `invoice_item_sold_price` INT);

-- -----------------------------------------------------
-- Placeholder table for view `emarket`.`report_month`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `emarket`.`report_month` (`category_id` INT, `category_name` INT, `category_sales` INT, `category_profit` INT, `category_revenue` INT);

-- -----------------------------------------------------
-- Placeholder table for view `emarket`.`report_week`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `emarket`.`report_week` (`category_id` INT, `category_name` INT, `category_sales` INT, `category_profit` INT, `category_revenue` INT);

-- -----------------------------------------------------
-- Placeholder table for view `emarket`.`report_day`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `emarket`.`report_day` (`category_id` INT, `category_name` INT, `category_sales` INT, `category_profit` INT, `category_revenue` INT);

-- -----------------------------------------------------
-- View `emarket`.`active_users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `emarket`.`active_users`;
USE `emarket`;
...
-- -----------------------------------------------------
-- View `emarket`.`products`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `emarket`.`products`;
USE `emarket`;
...
-- -----------------------------------------------------
-- View `emarket`.`report_params`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `emarket`.`report_params`;
USE `emarket`;
CREATE  OR REPLACE VIEW report_params AS SELECT 5000 as operation_cost, 0.05 as sales_fee_percent;

-- -----------------------------------------------------
-- View `emarket`.`report_items`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `emarket`.`report_items`;
USE `emarket`;
...
-- -----------------------------------------------------
-- View `emarket`.`report_month`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `emarket`.`report_month`;
USE `emarket`;
...
-- -----------------------------------------------------
-- View `emarket`.`report_week`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `emarket`.`report_week`;
USE `emarket`;
...
-- -----------------------------------------------------
-- View `emarket`.`report_day`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `emarket`.`report_day`;
USE `emarket`;
